...
namespace Seal.Controller
{
    ...
    public class ChallengeController : ControllerBase
    {
        ...
        //[HttpPost("Local")]
        //public async Task<IActionResult> CreateFromFile([FromForm] ChallengeCreateDto dto, IFormFile file)
        //{
        //    var userId = int.Parse(User.FindFirst("UserId")!.Value);
        //    var result = await _service.CreateFromFileAsync(dto, file, userId);
        //    return Ok(result);
        //}
        ...
        //[Authorize(Roles = "Partner")]
        //[HttpPost("link")]
        //public async Task<IActionResult> CreateFromLink([FromBody] ChallengeCreateLinkDto dto)
        //{
        //    var userId = int.Parse(User.FindFirst("UserId")!.Value);
        //    var result = await _service.CreateFromLinkAsync(dto, userId);
        //    return Ok(result);
        //}
