...
namespace Repositories.Migrations
{
    ...
    [Migration("20251006025258_UpdateSubmissionAndTeamChallenge")]
    partial class UpdateSubmissionAndTeamChallenge
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Repositories.Models.Challenge", b =>
                {
            ...
            modelBuilder.Entity("Repositories.Models.Season", b =>
                {
                    b.Property<int>("SeasonId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Repositories.Models.TeamChallenge", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("TeamChallengeId"));
            ...
            modelBuilder.Entity("Repositories.Models.TeamInvitation", b =>
                {
            ...
            modelBuilder.Entity("Repositories.Models.Challenge", b =>
                {
                    b.HasOne("Repositories.Models.Season", "Season")
                        .WithMany("Challenges")
            ...
            modelBuilder.Entity("Repositories.Models.Hackathon", b =>
                {
                    ...
                    b.HasOne("Repositories.Models.Season", "SeasonNavigation")
                        .WithMany("Hackathons")
            ...
            modelBuilder.Entity("Repositories.Models.Submission", b =>
                {
                    b.HasOne("Repositories.Models.Hackathon", null)
                        .WithMany("Submissions")
                        .HasForeignKey("HackathonId");

                    b.HasOne("Repositories.Models.HackathonPhase", "HackathonPhase")
                        .WithMany("Submissions")
                    ...
                    b.HasOne("Repositories.Models.User", "SubmittedByUser")
                        .WithMany("Submissions")
            ...
            modelBuilder.Entity("Repositories.Models.TeamInvitation", b =>
                {
                    b.HasOne("Repositories.Models.User", "InvitedByUser")
                        .WithMany()
